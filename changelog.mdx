---
title: Changelog
description: Version history and release notes for jecs
---

All notable changes to jecs are documented on this page.
...
### Fixed
- A linting problem with the types for `query:with` and `query:without`.
...
<Accordion title="0.5.0 and Earlier">
